...
(function () {
  ...
  /* The unit index on a board index is always open since the hub redesign
     of 2026-08-23 - the accordion that used to be toggled here is gone, and
     the topic links need no script to be reachable. */
